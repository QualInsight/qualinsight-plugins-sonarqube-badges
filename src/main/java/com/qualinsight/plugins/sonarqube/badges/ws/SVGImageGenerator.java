...
import com.qualinsight.plugins.sonarqube.badges.font.FontSelector;
...
public final class SVGImageGenerator {
    ...
    private static final Font FONT = FontSelector.select();
    ...
    private int computeWidth(final String text) {
        return (int) (FONT.getStringBounds(text, SVGImageGenerator.FONT_RENDER_CONTEXT).getWidth());
    }
}
