...
Plugin for SonarQube that generates badges (SVG images) displaying information about projects' or views' quality. 

Two types of badges are currently available: `quality gate` badges and `measure` badges. You can see a running example of a `quality gate` badge on the line below.
